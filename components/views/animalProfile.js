...
import { Text, View, Image, ScrollView, SafeAreaView, Linking, Alert } from "react-native";
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
            ...
            <Button 
              ...
              onPress={async () => {
                ...
                if(user !== undefined || user !== null) {
                  ...
                  return Alert.alert("Error", "This user has not added a valid e-mail address.");
                }
              }}
            ...
            <Button
              ...
              onPress={async () => {
                ...
                if(user !== undefined || user !== null) {
                  ...
                  return Alert.alert("Error", "This user has not added their phone number.");
                }
              }}
              ViewComponent={LinearGradient}
              linearGradientProps={{
        ...
        <View style={generalStyles.flexRow}>
          ...
          <GradientText style={styles.subItem}>{Math.round(Math.abs(new Date(item.birthDate) - Date.now()) / (1000 * 60 * 60 * 24)/365)}<Text> years old</Text></GradientText>
        </View>
